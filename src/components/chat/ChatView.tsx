          ...
          {activeGroup && activeGroupDetails ? (
            ...
            <div className="flex flex-col items-center justify-center p-8 text-center text-[#737874] m-auto max-w-sm">
              ...
              <div className="flex items-center gap-2 mt-4">
                <button
                  onClick={() => setIsCreateGroupOpen(true)}
                  className="px-4 py-2 rounded-xl text-xs font-bold bg-[#56615a] text-white shadow-xs"
                >
                  + Create Group
                </button>
                <button
                  onClick={() => setIsNewDirectOpen(true)}
                  className="px-4 py-2 rounded-xl text-xs font-semibold bg-[#F0EDED] text-[#1b1c1c]"
                >
                  Direct Chat
                </button>
              </div>
