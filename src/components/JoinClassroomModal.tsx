            ...
            <div>
              ...
              <div className="p-4 bg-[#F0EDED]/80 rounded-2xl border border-[#E5E4E2] mt-4 flex items-start gap-2.5">
                ...
                <p className="text-xs sm:text-sm text-[#434844] leading-relaxed">
                  Ask your batch representative or professor for the 6-to-8 character code. You can also test with{' '}
                  <span
                    onClick={() => setCode('BTECH26A')}
                    className="font-mono font-bold text-[#56615a] underline cursor-pointer bg-white px-1.5 py-0.5 rounded"
                  >
                    BTECH26A
                  </span>{' '}
                  (Oxford) or{' '}
                  <span
                    onClick={() => setCode('AIDS26A')}
                    className="font-mono font-bold text-[#56615a] underline cursor-pointer bg-white px-1.5 py-0.5 rounded"
                  >
                    AIDS26A
                  </span>{' '}
